...
// let numero = Number(prompt("Bienvenido al menu,las opciones son: 1:clasico 2:vegetariano 3:premium 4:salir"));
// while(numero != 4){
//     switch (numero){
//         case 1:
...
//             break;
//     }
//     numero = Number(prompt ("Bienvenido al menu,las opciones son: 1:clasico 2:vegetariano 3:premium 4:salir"));
// }
...
while(pedido != 4){
    ...
    pedido = Number(prompt ("Que opcion queres? (opcion 4 para salir del menu"));
}
